...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (location) {
    var marker = L.marker([location.coordinates[1], location.coordinates[0]], {
      icon: customIcon
    }).bindPopup("Day: ".concat(location.day, " /n ").concat(location.description));
...
var stripe;
if (window.Stripe) {
  stripe = Stripe('pk_test_51PSbjm03gPWLY730YcL0pZLEpPG9itTOlsoPjcA4ZtAM59LTDIaJBThOFRPpi8pRxj8EXsQZqMg3w8kfguc7oA3e006cJWsG92');
}
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (0, _alert.showAlert)('errro', _context.t0);
        case 13:
        case "end":
          return _context.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Created your account successfully');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
